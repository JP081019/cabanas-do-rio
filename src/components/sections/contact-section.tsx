        ...
        <div className="grid min-w-0 gap-6 lg:grid-cols-[0.92fr_1.08fr] lg:items-stretch">
          <div className="relative min-w-0 overflow-hidden rounded-lg bg-[#202a1f] p-6 text-white shadow-[0_30px_70px_rgba(32,42,31,0.24)] sm:p-10">
            ...
            <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
              ...
              <a
                className="group flex min-w-0 items-center gap-4 rounded-md border border-white/16 p-4 text-white transition hover:-translate-y-1 hover:bg-white/8 sm:gap-5 sm:p-5"
                href={contactLinks.phone}
              >
                <span className="flex h-14 w-14 shrink-0 items-center justify-center rounded-full bg-white/10 text-white ring-1 ring-white/15 sm:h-16 sm:w-16">
                  <Phone size={28} strokeWidth={1.45} />
                </span>
                <span className="min-w-0">
                  <span className="block text-xs uppercase tracking-[0.2em] text-white/54 sm:text-sm">Telefone</span>
                  <span className="mt-1 block font-serif text-[clamp(1.55rem,8vw,2rem)] leading-tight">Ligar agora</span>
                </span>
              </a>
            </div>
          </div>
